...
it writes. Sampling is GGX with alpha = roughness^2, matching sampleGGXNormal in Brdf/microfacet.part.glsl.
...
def smith_g1(cos_theta: np.ndarray, alpha: float) -> np.ndarray:
    """Exact Smith G1 for GGX, matching ggxSmithG1 in Brdf/microfacet.part.glsl."""
