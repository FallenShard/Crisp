...
namespace crisp
{
template <typename T, typename U, typename TIter = decltype(std::begin(std::declval<T>())),
    typename UIter = decltype(std::begin(std::declval<U>())), typename = decltype(std::end(std::declval<T>())),
