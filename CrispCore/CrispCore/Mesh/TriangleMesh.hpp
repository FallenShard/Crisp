...
#include <CrispCore/Mesh/VertexAttributeBuffer.hpp>
...
namespace crisp
{
    ...
    {
    public:
        TriangleMesh(std::vector<glm::vec3> positions, std::vector<glm::vec3> normals,
            std::vector<glm::vec2> texCoords, std::vector<glm::uvec3> faces, std::vector<VertexAttributeDescriptor> vertexAttributes);
