...
namespace crisp
{
    ...
    SkyViewLutPass::SkyViewLutPass(Renderer* renderer, VkExtent2D renderArea)
        : VulkanRenderPass(renderer, false, 1)
    {
    }
    ...
    CameraVolumesPass::CameraVolumesPass(Renderer* renderer, VkExtent2D renderArea)
        : VulkanRenderPass(renderer, false, 1)
    {
    }
    ...
    RayMarchingPass::RayMarchingPass(Renderer* renderer, VkExtent2D renderArea)
        : VulkanRenderPass(renderer, false, 1)
    {
    }
