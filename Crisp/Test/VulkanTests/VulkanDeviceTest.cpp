...
//    const auto queueFamilies = physicalDevice.queryQueueFamilyIndices(vulkanInit.context.getSurface());
...
//
//    const auto surfaceSupport = physicalDevice.querySurfaceSupport(vulkanInit.context.getSurface());
...
//{
//    const auto& [physicalDevice, vulkanInit] = createPhysicalDeviceWithSurface();
//    const auto queueConfig = createDefaultQueueConfiguration(vulkanInit.context, physicalDevice);
