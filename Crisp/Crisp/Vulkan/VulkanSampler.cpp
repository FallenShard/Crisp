...
namespace crisp
{
VulkanSampler::VulkanSampler(const VulkanDevice& device, VkFilter minFilter, VkFilter magFilter,
...
VulkanSampler::VulkanSampler(const VulkanDevice& device, VkFilter minFilter, VkFilter magFilter,
    VkSamplerAddressMode addressMode, float anisotropy, float maxLod)
