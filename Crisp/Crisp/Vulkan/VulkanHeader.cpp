...
#if defined(VK_VERSION_1_3)
    VK_LOAD_DEVICE_FUNC(vkGetPhysicalDeviceToolProperties)
    VK_LOAD_DEVICE_FUNC(vkCreatePrivateDataSlot)
    VK_LOAD_DEVICE_FUNC(vkDestroyPrivateDataSlot)
    VK_LOAD_DEVICE_FUNC(vkSetPrivateData)
    VK_LOAD_DEVICE_FUNC(vkGetPrivateData)
    VK_LOAD_DEVICE_FUNC(vkCmdSetEvent2)
    VK_LOAD_DEVICE_FUNC(vkCmdResetEvent2)
    VK_LOAD_DEVICE_FUNC(vkCmdWaitEvents2)
    VK_LOAD_DEVICE_FUNC(vkCmdPipelineBarrier2)
    VK_LOAD_DEVICE_FUNC(vkCmdWriteTimestamp2)
    VK_LOAD_DEVICE_FUNC(vkQueueSubmit2)
    VK_LOAD_DEVICE_FUNC(vkCmdCopyBuffer2)
    VK_LOAD_DEVICE_FUNC(vkCmdCopyImage2)
    VK_LOAD_DEVICE_FUNC(vkCmdCopyBufferToImage2)
    VK_LOAD_DEVICE_FUNC(vkCmdCopyImageToBuffer2)
    VK_LOAD_DEVICE_FUNC(vkCmdBlitImage2)
    VK_LOAD_DEVICE_FUNC(vkCmdResolveImage2)
    VK_LOAD_DEVICE_FUNC(vkCmdBeginRendering)
    VK_LOAD_DEVICE_FUNC(vkCmdEndRendering)
    VK_LOAD_DEVICE_FUNC(vkCmdSetCullMode)
    VK_LOAD_DEVICE_FUNC(vkCmdSetFrontFace)
    VK_LOAD_DEVICE_FUNC(vkCmdSetPrimitiveTopology)
    VK_LOAD_DEVICE_FUNC(vkCmdSetViewportWithCount)
    VK_LOAD_DEVICE_FUNC(vkCmdSetScissorWithCount)
    VK_LOAD_DEVICE_FUNC(vkCmdBindVertexBuffers2)
    VK_LOAD_DEVICE_FUNC(vkCmdSetDepthTestEnable)
    VK_LOAD_DEVICE_FUNC(vkCmdSetDepthWriteEnable)
    VK_LOAD_DEVICE_FUNC(vkCmdSetDepthCompareOp)
    VK_LOAD_DEVICE_FUNC(vkCmdSetDepthBoundsTestEnable)
    VK_LOAD_DEVICE_FUNC(vkCmdSetStencilTestEnable)
    VK_LOAD_DEVICE_FUNC(vkCmdSetStencilOp)
    VK_LOAD_DEVICE_FUNC(vkCmdSetRasterizerDiscardEnable)
    VK_LOAD_DEVICE_FUNC(vkCmdSetDepthBiasEnable)
    VK_LOAD_DEVICE_FUNC(vkCmdSetPrimitiveRestartEnable)
    VK_LOAD_DEVICE_FUNC(vkGetDeviceBufferMemoryRequirements)
    VK_LOAD_DEVICE_FUNC(vkGetDeviceImageMemoryRequirements)
    VK_LOAD_DEVICE_FUNC(vkGetDeviceImageSparseMemoryRequirements)
#endif
