...
namespace crisp
{
    VulkanFramebuffer::VulkanFramebuffer(const VulkanDevice& device, VkRenderPass renderPass, VkExtent2D extent, const std::vector<VkImageView>& attachments, uint32_t layers, VkFramebufferCreateFlags flags)
