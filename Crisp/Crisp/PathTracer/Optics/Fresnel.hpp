...
public:
    ...
    static float getIOR(IndexOfRefraction iorMaterial) {
        ...
        case IndexOfRefraction::Air:
            return 1.00029f;
        case IndexOfRefraction::Ice:
            return 1.31f;
        case IndexOfRefraction::Water:
            return 1.33f;
        case IndexOfRefraction::Glass:
            return 1.5046f;
        case IndexOfRefraction::Sapphire:
            return 1.77f;
        case IndexOfRefraction::Diamond:
            return 2.417f;
        default:
            return 1.0f;
        }
    ...
    static RgbSpectrum conductor(float cosThetaI, const ComplexIOR& ior) {
        ...
        RgbSpectrum Rp = (squareTerm * cosTheta2 - etaCosTheta + 1) / (squareTerm * cosTheta2 + etaCosTheta + 1);

        RgbSpectrum Rs = (squareTerm + cosTheta2 - etaCosTheta) / (squareTerm + cosTheta2 + etaCosTheta);
