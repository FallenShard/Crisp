...
void CrispGui::setupInputCallbacks(Form* /*form*/, Application* /*app*/, Scene* /*scene*/)
{
    ...
    //     stringStream << std::fixed << std::setprecision(2) << std::setfill('0') << percentage * 100 << " %    ETA: "
    //     << remainingPct << " s"; progressLabel->setText(stringStream.str());
...
void CrispGui::buildVectorDisplayInfo(Form* form, ControlGroup& parent, std::string labelName,
    std::string&& dataLabelId, float verticalOffset)
{
