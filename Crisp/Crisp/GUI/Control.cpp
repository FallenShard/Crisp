...
glm::vec2 Control::getAnchorOffset() const
{
    ...
    default:
    case Anchor::TopLeft:
        return glm::vec2(paddingX[0], paddingY[0]);
    case Anchor::TopCenter:
        return glm::vec2(parentSize.x / 2.0f, paddingY[0]);
    case Anchor::TopRight:
        return glm::vec2(parentSize.x - paddingX[1], paddingY[0]);
    case Anchor::CenterLeft:
        return glm::vec2(paddingX[0], parentSize.y / 2.0f);
    case Anchor::Center:
        return parentSize / 2.0f;
    case Anchor::CenterRight:
        return glm::vec2(parentSize.x - paddingX[1], parentSize.y / 2.0f);
    case Anchor::BottomLeft:
        return glm::vec2(paddingX[0], parentSize.y - paddingY[1]);
    case Anchor::BottomCenter:
        return glm::vec2(parentSize.x / 2.0f, parentSize.y - paddingY[1]);
    case Anchor::BottomRight:
        return parentSize - glm::vec2(paddingX[1], paddingY[1]);
    }
}
