...
namespace crisp
{
    ...
    void PbrScene::createGui(gui::Form* form)
    {
        ...
        auto roughnessLabel = std::make_unique<Label>(form, "Roughness");
        roughnessLabel->setPosition({ 0, y });
        panel->addControl(std::move(roughnessLabel));
        y += 20;
        ...
        roughnessSlider->setValue(m_uniformMaterialParams.roughness);
        roughnessSlider->setIncrement(0.01f);
        roughnessSlider->valueChanged.subscribe<&PbrScene::setRoughness>(this);
        ...
        metallicSlider->setValue(m_uniformMaterialParams.metallic);
        metallicSlider->setIncrement(0.01f);
        metallicSlider->valueChanged.subscribe<&PbrScene::setMetallic>(this);
        ...
        redSlider->setValue(m_uniformMaterialParams.albedo.r);
        redSlider->setIncrement(0.01f);
        redSlider->valueChanged.subscribe<&PbrScene::setRedAlbedo>(this);
        ...
        greenSlider->setValue(m_uniformMaterialParams.albedo.g);
        greenSlider->setIncrement(0.01f);
        greenSlider->valueChanged.subscribe<&PbrScene::setGreenAlbedo>(this);
        ...
        blueSlider->setValue(m_uniformMaterialParams.albedo.b);
        blueSlider->setIncrement(0.01f);
        blueSlider->valueChanged.subscribe<&PbrScene::setBlueAlbedo>(this);
        panel->addControl(std::move(blueSlider));
        y += 30;

        auto uSlider = std::make_unique<DoubleSlider>(form, 0.0f, 10.0f);
        uSlider->setId("uSlider");
        uSlider->setAnchor(Anchor::TopCenter);
        uSlider->setOrigin(Origin::TopCenter);
        uSlider->setPosition({ 0, y });
        uSlider->setValue(m_shaderBallUVScale.s);
        uSlider->setIncrement(0.1f);
        uSlider->valueChanged.subscribe<&PbrScene::setUScale>(this);
        panel->addControl(std::move(uSlider));
        y += 30;

        auto vSlider = std::make_unique<DoubleSlider>(form, 0.0f, 10.0f);
        vSlider->setId("vSlider");
        vSlider->setAnchor(Anchor::TopCenter);
        vSlider->setOrigin(Origin::TopCenter);
        vSlider->setPosition({ 0, y });
        vSlider->setValue(m_shaderBallUVScale.t);
        vSlider->setIncrement(0.1f);
        vSlider->valueChanged.subscribe<&PbrScene::setVScale>(this);
        panel->addControl(std::move(vSlider));
        y += 30;
