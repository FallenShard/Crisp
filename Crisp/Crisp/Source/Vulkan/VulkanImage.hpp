...
namespace crisp
{
    ...
    public:
        ...
        VkImageView createView(VkImageViewType type, uint32_t baseLayer, uint32_t numLayers, uint32_t baseMipLevel, uint32_t mipLevels) const;
    ...
    private:
        std::pair<VkAccessFlags, VkAccessFlags> determineAccessFlags(VkImageLayout oldLayout, VkImageLayout newLayout) const;
