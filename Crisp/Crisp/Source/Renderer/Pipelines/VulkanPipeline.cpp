...
namespace crisp
{
    ...
    {
        return m_descriptorSetLayouts[setId]->allocateSet(m_descriptorPool);
    }

    std::vector<VkDescriptorSet> VulkanPipeline::allocateDescriptorSet(uint32_t setId, uint32_t count) const
    {
        return m_descriptorSetLayouts[setId]->allocateSets(m_descriptorPool, count);
    }
    ...
    std::shared_ptr<VulkanDescriptorSetLayout> VulkanPipeline::createDescriptorSetLayout(const std::vector<VkDescriptorSetLayoutBinding>& bindings, VkDescriptorSetLayoutCreateFlags flags)
    {
    ...
    VkPipelineLayout VulkanPipeline::createPipelineLayout(const std::vector<std::shared_ptr<VulkanDescriptorSetLayout>>& setLayouts, const std::vector<VkPushConstantRange>& pushConstants)
    {
