...
namespace crisp
{
    TexturePass::TexturePass(Renderer* renderer, VkExtent2D renderArea)
        : VulkanRenderPass(renderer, false, 1)
    {
        ...
        m_handle = RenderPassBuilder()
            .addAttachment(VK_FORMAT_R16G16_SFLOAT, VK_SAMPLE_COUNT_1_BIT)
    ...
    void TexturePass::createResources()
    {
        ...
        m_renderTargets[0] = std::make_unique<VulkanImage>(m_device, extent, numLayers, 1, VK_FORMAT_R16G16_SFLOAT,
