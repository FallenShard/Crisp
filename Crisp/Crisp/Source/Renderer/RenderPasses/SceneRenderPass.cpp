...
namespace crisp
{
    SceneRenderPass::SceneRenderPass(Renderer* renderer)
        : VulkanRenderPass(renderer, true, 1)
    {
        ...
        m_handle = RenderPassBuilder()
            ...
            .setAttachmentOps(Opaque, VK_ATTACHMENT_LOAD_OP_CLEAR, VK_ATTACHMENT_STORE_OP_STORE)
            .setAttachmentLayouts(Opaque, VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL, VK_IMAGE_LAYOUT_COLOR_ATTACHMENT_OPTIMAL)
            ...
            .setNumSubpasses(1)
            .addColorAttachmentRef(0, Opaque, VK_IMAGE_LAYOUT_COLOR_ATTACHMENT_OPTIMAL)
