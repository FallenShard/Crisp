...
VulkanPipeline* ResourceContext::createPipeline(std::string id, std::string_view luaFilename,
...
void ResourceContext::addImageWithView(std::string key, std::unique_ptr<VulkanImage> image,
...
RenderNode* ResourceContext::createPostProcessingEffectNode(std::string renderNodeId, std::string pipelineLuaFilename,
...
{
    recompileShaderDir(ApplicationEnvironment::getShaderSourcesPath(),
